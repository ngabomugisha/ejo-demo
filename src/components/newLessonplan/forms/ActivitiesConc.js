...
export const ActivitiesConc = (props) => {
  ...
  const assignIntro = (newLessonPlan, formData) => {
    newLessonPlan.activities.conclusion = formData.conclusion;
  };
  ...
  const handleAddChange = (e) => {
    if (e.target.name === "content") {
      newLessonPlan.activities.conclusion.content.activities.push({
        activity: e.target.value,
      });
    } else if (e.target.name == "crossCuttingIssues") {
      newLessonPlan.activities.conclusion.crossCuttingIssues.issues.push({
        issue: e.target.value,
      });
    } else if (e.target.name == "competency") {
      newLessonPlan.activities.conclusion.competency.competencies.push({
  ...
  const handleRemoveChange = (e) => {
    if (e.target.name === "content") {
      var contentIndex =
        newLessonPlan.activities.conclusion.content.activities.indexOf(
          e.target.value
        );
      newLessonPlan.activities.conclusion.content.activities.splice(
        contentIndex,
        1
      );
    } else if (e.target.name == "crossCuttingIssues") {
      var issueIndex =
        newLessonPlan.activities.conclusion.crossCuttingIssues.issues.indexOf(
          e.target.value
        );
      newLessonPlan.activities.conclusion.crossCuttingIssues.issues.splice(
        issueIndex,
        1
      );
    } else if (e.target.name == "competency") {
      var competencyIndex =
        newLessonPlan.activities.conclusion.competency.competencies.indexOf(
          e.target.value
        );
      newLessonPlan.activities.conclusion.competency.competencies.splice(
        competencyIndex,
        1
      );
    }
  ...
  const handleQuestionClick = (e) => {
    ...
    if (e.target.checked) {
      newLessonPlan.activities.conclusion.exercises.questions.push(quest);
    } else {
      var questionIndex =
  ...
  const handleTextField = (e) => {
    if (e.target.name === "otherActivity") {
      newLessonPlan.activities.conclusion.content.otherActivity =
        e.target.value;
    } else if (e.target.name === "crossCuttingIssues") {
      newLessonPlan.activities.conclusion.crossCuttingIssues.omment =
        e.target.value;
    } else if (e.target.name === "competency") {
      newLessonPlan.activities.conclusion.competency.comment = e.target.value;
    }
  };
      ...
      if (newLessonPlan.unit) {
        const req = await https
          ...
          .then((res) => {
            ...
            //setContentconclusionData(res.data.activities)
...
export default connect(mapStateToProps, mapDispatchToProps)(ActivitiesConc);
