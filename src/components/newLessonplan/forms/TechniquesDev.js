...
export const TechniquesDev = (props) => {
  ...
  const handleAddChange = (e) => {
    if (e.target.name === "contentFocus") {
      newLessonPlan.teachingTechniques.development.contentFocus.push({
        item: e.target.value,
      });
    } else if (e.target.name === "interactiveFocus") {
      newLessonPlan.teachingTechniques.development.interactiveFocus.push({
        item: e.target.value,
      });
    } else if (e.target.name === "criticalThinking") {
      newLessonPlan.teachingTechniques.development.criticalThinking.push({
        item: e.target.value,
      });
    } else if (e.target.name === "production") {
      newLessonPlan.teachingTechniques.development.production.push({
        item: e.target.value,
      });
    } else if (e.target.name === "problemSolving") {
      newLessonPlan.teachingTechniques.development.problemSolving.push({
        item: e.target.value,
      });
    } else if (e.target.name === "reflection") {
      newLessonPlan.teachingTechniques.development.reflection.push({
        item: e.target.value,
      });
    } else if (e.target.name === "sittingArrangement") {
      newLessonPlan.teachingTechniques.development.sitingArrangement.push({
        item: e.target.value,
      });
    }
  };
  ...
  const handleRemoveChange = (e) => {
    if (e.target.name === "contentFocus") {
      var contentIndex =
        newLessonPlan.teachingTechniques.development.contentFocus.indexOf(
          e.target.value
        );
      newLessonPlan.teachingTechniques.development.contentFocus.splice(
        contentIndex,
        1
      );
    } else if (e.target.name === "interactiveFocus") {
      var contentIndex =
        newLessonPlan.teachingTechniques.development.interactiveFocus.indexOf(
          e.target.value
        );
      newLessonPlan.teachingTechniques.development.interactiveFocus.splice(
        contentIndex,
        1
      );
    } else if (e.target.name === "criticalThinking") {
      var contentIndex =
        newLessonPlan.teachingTechniques.development.criticalThinking.indexOf(
          e.target.value
        );
      newLessonPlan.teachingTechniques.development.criticalThinking.splice(
        contentIndex,
        1
      );
    } else if (e.target.name === "production") {
      var contentIndex =
        newLessonPlan.teachingTechniques.development.production.indexOf(
          e.target.value
        );
      newLessonPlan.teachingTechniques.development.production.splice(
        contentIndex,
        1
      );
    } else if (e.target.name === "problemSolving") {
      var contentIndex =
        newLessonPlan.teachingTechniques.development.problemSolving.indexOf(
          e.target.value
        );
      newLessonPlan.teachingTechniques.development.problemSolving.splice(
        contentIndex,
        1
      );
    } else if (e.target.name === "reflection") {
      var contentIndex =
        newLessonPlan.teachingTechniques.development.reflection.indexOf(
          e.target.value
        );
      newLessonPlan.teachingTechniques.development.reflection.splice(
        contentIndex,
        1
      );
    } else if (e.target.name === "sittingArrangement") {
      var contentIndex =
        newLessonPlan.teachingTechniques.development.sitingArrangement.indexOf(
          e.target.value
        );
      newLessonPlan.teachingTechniques.development.sitingArrangement.splice(
        contentIndex,
        1
      );
    }
  ...
  const handleTextField = (e) => {
      newLessonPlan.teachingTechniques.development.duration =
        e.target.value;
    }
  ...
  }, [contentFocusArr, interactiveFocusArr, criticalThinkingArr, productionArr, problemSolvingArr, reflectionArr, sittingArrangementArr ]);
...
export default connect(mapStateToProps, mapDispatchToProps)(TechniquesDev);
