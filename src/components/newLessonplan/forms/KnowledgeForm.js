...
export const KnowledgeForm = (props) => {
        ...
        uploadsKnowledge.map((i) => {
            if (id === i.id) {
                ...
                else 
                {
                    ...
                    {   i.items &&
                        i.items.push({item : event.target.name})
                    }else{
                        i.items &&
                        i.items.splice(i.items.findIndex(x => x.item === event.target.name),1)
                    }
                }
            }
            return i;
    ...
    useEffect(() => {
        console.log("********", inputsKnowledge, "%%%%%%%%%%", uploadsKnowledge, "&&&&&&&&", allData)
    }, [materialReference])
                        ...
                        <div className="knowledge-container-2">
                            ...
                            <div className="field">
                                <TextField
                                    ...
                                    value={input.standardCriteriaPerfomance && input.standardCriteriaPerfomance}
                                    onChange={(e) => handleChangeInputKnowledge(input.id, e)}
                            ...
                            <ProgressBar now={input.standardCriteriaPerfomance} label={`${input.standardCriteriaPerfomance}%`} />
              ...
              <button className="check-btn-2">
                ...
                {uploadsKnowledge.map((input) => (
                  ...
                  Upload Content</h7>
                            ...
                            <div className="delete-btn">{uploadsKnowledge.length <= 1 ? "" :
                                <button
                                    style={{ color: "red" }}
