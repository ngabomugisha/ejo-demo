...
export const TechniquesConc = (props) => {
  ...
  const handleAddChange = (e) => {
    if (e.target.name === "contentFocus") {
      newLessonPlan.teachingTechniques.conclusion.contentFocus.push({
        item: e.target.value,
      });
    } else if (e.target.name === "interactiveFocus") {
      newLessonPlan.teachingTechniques.conclusion.interactiveFocus.push({
        item: e.target.value,
      });
    } else if (e.target.name === "criticalThinking") {
      newLessonPlan.teachingTechniques.conclusion.criticalThinking.push({
        item: e.target.value,
      });
    } else if (e.target.name === "production") {
      newLessonPlan.teachingTechniques.conclusion.production.push({
        item: e.target.value,
      });
    } else if (e.target.name === "problemSolving") {
      newLessonPlan.teachingTechniques.conclusion.problemSolving.push({
        item: e.target.value,
      });
    } else if (e.target.name === "reflection") {
      newLessonPlan.teachingTechniques.conclusion.reflection.push({
        item: e.target.value,
      });
    } else if (e.target.name === "sittingArrangement") {
      newLessonPlan.teachingTechniques.conclusion.sitingArrangement.push({
        item: e.target.value,
      });
    }
  };
  ...
  const handleRemoveChange = (e) => {
    if (e.target.name === "contentFocus") {
      var contentIndex =
        newLessonPlan.teachingTechniques.conclusion.contentFocus.indexOf(
          e.target.value
        );
      newLessonPlan.teachingTechniques.conclusion.contentFocus.splice(
        contentIndex,
        1
      );
    } else if (e.target.name === "interactiveFocus") {
      var contentIndex =
        newLessonPlan.teachingTechniques.conclusion.interactiveFocus.indexOf(
          e.target.value
        );
      newLessonPlan.teachingTechniques.conclusion.interactiveFocus.splice(
        contentIndex,
        1
      );
    } else if (e.target.name === "criticalThinking") {
      var contentIndex =
        newLessonPlan.teachingTechniques.conclusion.criticalThinking.indexOf(
          e.target.value
        );
      newLessonPlan.teachingTechniques.conclusion.criticalThinking.splice(
        contentIndex,
        1
      );
    } else if (e.target.name === "production") {
      var contentIndex =
        newLessonPlan.teachingTechniques.conclusion.production.indexOf(
          e.target.value
        );
      newLessonPlan.teachingTechniques.conclusion.production.splice(
        contentIndex,
        1
      );
    } else if (e.target.name === "problemSolving") {
      var contentIndex =
        newLessonPlan.teachingTechniques.conclusion.problemSolving.indexOf(
          e.target.value
        );
      newLessonPlan.teachingTechniques.conclusion.problemSolving.splice(
        contentIndex,
        1
      );
    } else if (e.target.name === "reflection") {
      var contentIndex =
        newLessonPlan.teachingTechniques.conclusion.reflection.indexOf(
          e.target.value
        );
      newLessonPlan.teachingTechniques.conclusion.reflection.splice(
        contentIndex,
        1
      );
    } else if (e.target.name === "sittingArrangement") {
      var contentIndex =
        newLessonPlan.teachingTechniques.conclusion.sitingArrangement.indexOf(
          e.target.value
        );
      newLessonPlan.teachingTechniques.conclusion.sitingArrangement.splice(
        contentIndex,
        1
      );
    }
  ...
  const handleTextField = (e) => {
      newLessonPlan.teachingTechniques.conclusion.duration =
        e.target.value;
    }
