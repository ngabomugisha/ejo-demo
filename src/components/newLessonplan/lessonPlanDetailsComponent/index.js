			...
			<div className="plan-container">
				<div className="titl">
					...
					<div className="titl2">
						...
						<h5>
							Sed ut perspiciatis undeomnis iste natus error sit voluptatem
						</h5>
					</div>
					<div className="titl2">
						<h4>3. Unit:</h4>
					...
					<div className="titl2">
						...
						<h5>
							Key Unit Competency: Sed ut perspiciat unde omnis iste natus error
					...
					<Card>
						...
						<Accordion.Collapse eventKey="0">
							<Card.Body>
								<div className="in-card-title">
									<h4>Content Focus:</h4>
									<h5>Live Lecturing Assigned Reading/Text </h5>
								</div>
								<div className="in-card-title">
								...
								<div className="in-card-title">
									<h4>
										Critical Thinking: Production: Problem Solving: Reflection:
									</h4>
									<h5></h5>
								</div>
							</Card.Body>
							...
							<Card.Body>
								<div className="in-card-title">
									...
									<h5>
										Sed ut perspiciatis unde omnis iste natus error sit
										voluptatem accusantium doloremque laudantium, totam rem
										aperiam, eaque ipsa quae ab illo Attitude: Sed ut
										perspiciatis Skills: Sed ut perspiciat unde omnis iste natus
										error sit voluptatem accusantium doloremque laudantium, Sed
