...
export const LessonPlan_start = (props) => {
	...
	console.log("data at the beginning:", newLessonPlan);
	...
	const assignStatevalues = (newLessonPlan, formData) => {
		newLessonPlan.assignedClass = formData.assignedClass;
	...
	const validateFields = (newLessonPlan) => {
				...
				<Grid item xs={12}>
					<Button
						...
						onClick={() => {
							...
							if (validateFields(newLessonPlan)) {
