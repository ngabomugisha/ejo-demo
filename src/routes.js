...
import LessonReview from "./components/newLessonplan/stepForm/lessonReview";
		...
		>
			<Router>
				<Switch>
					...
					<Route
						exact
						path="/teacher/lessonPlan/details"
						component={LessonPlanDetailsPage}
					/>
					<Route
						exact
						path="/teacher/newLessonPlan"
						component={NewLessonPlanPage}
					/>
					<Route
						exact
						path="/teacher/newLessonPlan/details"
						component={LessonReview}
					/>
					<Route exact path="/teacher/assignment" component={AssignmentPage} />
					<Route
						exact
						path="/teacher/newAssignment"
					...
					<Route
						exact
						path="/schoolAdmin/discipline"
						component={disciplinePage}
					/>
					<Route
						exact
						path="/schoolAdmin/questions"
					...
					<Route
						exact
						path="/schoolAdmin/teachers/classes"
						component={TeachersClassPage}
					/>
